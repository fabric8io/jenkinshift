...
node{
  ...
  .withPrivileged(true).inside {
    ...
    sh "mkdir -p ../go/src/github.com/fabric8io/jenkinshift; cp -R ../${env.JOB_NAME}/. ../go/src/github.com/fabric8io/jenkinshift/; cd ../go/src/github.com/fabric8io/jenkinshift; make build test lint"
